...
1. RECALL BEFORE YOU ANSWER. Open a conversation with `recall` and no query: the briefing. Before answering
   ...
   "Anna's siblings", "Mattias's parents and Anna's siblings", "Mattias's family". Recall too before storing
   what may already be known.
...
3. RECORD WHAT THE USER STATES: a fact, a decision, a preference, a correction, or a contradiction of what you
   recalled. Call `remember` with the utterance verbatim and your reading as `proposal`, at natural
   boundaries, not after every message. Read `inspect('guide')` before your first proposal in a session: it
